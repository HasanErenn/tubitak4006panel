    ...
    tempDiv.innerHTML = `
      <div style="padding: 32px; background: white; min-height: 100vh; font-family: Arial, sans-serif;">
        ...
        <div style="text-align: center; margin-bottom: 32px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
            ...
            <div style="flex: 1; margin: 0 16px;">
              <h1 style="font-size: 18px; font-weight: bold; margin: 0 0 8px 0; letter-spacing: 2px;">TÜBİTAK 4006 TÜBA-GEBİP</h1>
              <h2 style="font-size: 16px; font-weight: 600; margin: 0 0 4px 0; letter-spacing: 1px;">ALT PROJE BAŞVURU FORMU</h2>
              <p style="font-size: 12px; margin: 0;">Bilim İnsanı Destekleme Daire Başkanlığı</p>
            </div>
        ...
        <div style="margin-bottom: 32px;">
          <h3 style="text-align: center; font-size: 18px; font-weight: bold; margin-bottom: 24px; letter-spacing: 2px;">PROJE BİLGİLERİ</h3>
        ...
        <!-- Footer -->
        <div style="margin-top: 32px; text-align: center; font-size: 12px; color: #666; font-style: italic;">
...
const PDFTemplate: React.FC<{ userInfo: UserInfo; user: User }> = ({ userInfo, user }) => {
  return (
    <div className="bg-white p-8 min-h-screen font-sans text-sm">
      {/* Header */}
